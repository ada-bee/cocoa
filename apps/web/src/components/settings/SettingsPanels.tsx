import { ArchiveIcon, ArchiveX, EllipsisIcon, LoaderIcon, SettingsIcon } from "lucide-react";
...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const isProviderDefaultModelDirty = Object.keys(settings.defaultModelSelections ?? {}).length > 0;
  ...
  const changedSettingLabels = useMemo(
    () => [
      ...
      ...(isProviderDefaultModelDirty ? ["Provider default models"] : []),
    ],
    [
      isTextGenerationModelDirty,
      isProviderDefaultModelDirty,
