// @effect-diagnostics nodeBuiltinImport:off,anyUnknownInErrorContext:off - pre-ready Electron setup reads persisted settings synchronously before app services are available.
