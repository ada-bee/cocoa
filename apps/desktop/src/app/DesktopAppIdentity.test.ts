...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Cocoa Code.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Cocoa Code.app/Contents/Resources",
...
const makeElectronAppLayer = (calls: ElectronAppCalls) =>
  Layer.succeed(ElectronApp.ElectronApp, {
    ...
    name: Effect.succeed("Cocoa Code"),
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Cocoa Code (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Cocoa Code (Alpha)");
