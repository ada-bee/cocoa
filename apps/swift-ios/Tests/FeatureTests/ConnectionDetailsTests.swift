...
struct ConnectionDetailsTests {
    ...
    @Test(arguments: [
        "cocoa://pair?pairingUrl=https%3A%2F%2Fremote.example.com%2Fpair%23token%3Dpairing-token",
        "cocoa-dev://pair?pairingUrl=https%3A%2F%2Fremote.example.com%2Fpair%23token%3Dpairing-token",
    ...
    func mapsCancellationToUsefulCopy() {
        ...
        #expect(message.contains("Make sure the Cocoa gateway is running"))
    }
}
