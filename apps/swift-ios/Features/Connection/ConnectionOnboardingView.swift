...
public struct ConnectionOnboardingView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("Cocoa")
                    ...
                    .accessibilityLabel("Cocoa")

                Text("Your Codex hosts,\none gateway.")
                    .font(.system(size: 38, weight: .bold, design: .default))
                    .tracking(-1.1)
                    .padding(.top, 24)

                Text("Pair this device with your Cocoa gateway.")
                    .font(.body)
                ...
                VStack(spacing: 0) {
                    connectionAction(
                        title: "Scan QR code",
                        subtitle: "Scan a one-time code from Cocoa",
                    ...
                    connectionAction(
                        ...
                        subtitle: "Copy it from your Cocoa gateway",
                    ...
                    connectionAction(
                        ...
                        subtitle: "Use the gateway address and pairing code",
        ...
        if !model.snapshot.environments.isEmpty {
            VStack(alignment: .leading, spacing: 0) {
                ...
                ForEach(model.snapshot.environments) { environment in
                    ...
                    .buttonStyle(.plain)
                    .accessibilityHint("Reconnects to this gateway")
            ...
            VStack(alignment: .leading, spacing: 24) {
                VStack(alignment: .leading, spacing: 8) {
                    Text(entryHeading)
                        ...
                        .tracking(-0.6)
                    Text("Both values are shown by Cocoa when you create a mobile connection.")
                        .font(T3Typography.threadBody)
                        .foregroundStyle(T3Colors.textSecondary)
                }
    ...
    private var progressView: some View {
        VStack(alignment: .leading, spacing: 34) {
            ...
            Text("Keep the Cocoa gateway running while pairing.")
                .font(T3Typography.supporting)
                .foregroundStyle(T3Colors.textSecondary)
        }
    ...
    private func connect(_ action: ConnectionAction) {
        ...
        connectionTask = Task {
            ...
            case .localNetworkDenied:
                errorMessage = "Allow Local Network access so this iPhone can reach your Cocoa gateway."
                showsPermissionAction = true
                stage = .details
                return
            case .unreachable:
                errorMessage = "This iPhone cannot reach that gateway. Confirm the address and network route."
                stage = .details
                return
            }
