...
struct PlatformRecentThreadEntity: AppEntity {
    static let typeDisplayRepresentation = TypeDisplayRepresentation(name: "Cocoa Thread")
...
struct NewT3TaskIntent: AppIntent {
    static let title: LocalizedStringResource = "New Cocoa Task"
...
struct OpenRecentT3ThreadIntent: AppIntent {
    static let title: LocalizedStringResource = "Open Recent Cocoa Thread"
    static let description = IntentDescription("Open a recent thread in Cocoa.")
    static let openAppWhenRun = true
