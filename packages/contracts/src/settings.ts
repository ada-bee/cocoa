...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Cocoa Code spawn the server when needed.",
        providerSettingsForm: {
...
export const ServerSettings = Schema.Struct({
  ...
  // Compatibility storage for host-owned defaults while Cocoa's current
  // one-host/one-Codex-instance projection is migrated to first-class hosts.
  defaultModelSelections: Schema.optionalKey(Schema.Record(ProviderInstanceId, ModelSelection)),
