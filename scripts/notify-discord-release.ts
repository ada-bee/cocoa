  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Cocoa Code prerelease is available for nightly testers."
          : "A new Cocoa Code latest release is available.",
...
).pipe(Command.withDescription("Post a Cocoa Code release announcement to Discord."));
